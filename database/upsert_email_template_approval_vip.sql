...
DELETE FROM public.email_templates WHERE slug = 'approval-vip';
...
VALUES (
  ...
  '<!DOCTYPE html>
<!-- ═══════════════════════════════════════════════════════════════════════
     APPROVAL EMAIL · VIP MAIN ATTENDEE
     Same merge fields as approval.html. Use when the guest is marked VIP in admin.
     Variables: same as approval.html + {{salutation_first_name}} for the headline + all calendar / QR / host aliases from Edge Function.
     ═══════════════════════════════════════════════════════════════════════ -->
<html lang="en">
...
<div style="font-family:''Courier New'',monospace;font-size:11px;letter-spacing:0.2em;color:#6b5228;text-transform:uppercase;margin-bottom:20px;line-height:1.45;">VIP confirmation · Reservation #{{reservation_id}}</div>
<h1 style="margin:0 0 24px 0;font-family:''Fraunces'',Georgia,serif;font-size:36px;font-weight:400;line-height:1.1;color:#0a0a0a;letter-spacing:-0.02em;">Your VIP seat is confirmed,<br><em style="font-style:italic;color:#8b6f3a;">{{salutation_first_name}}.</em></h1>
...
<div style="font-family:''Courier New'',monospace;font-size:10px;letter-spacing:0.24em;color:#8b6f3a;text-transform:uppercase;margin-bottom:16px;">Save the date</div>
...
<p style="margin:24px 0 0 0;font-family:''Courier New'',monospace;font-size:10px;letter-spacing:0.1em;color:#8b6f3a;text-align:center;text-transform:uppercase;">VIP confirmation · {{event_city}} Vol. {{event_volume}}</p>
</td></tr></table>
</body></html>
',
  true
